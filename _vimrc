...
if has("autocmd")
	if !exists("autocommands_loaded")
		...
		" Place the txt.vim file in folder %UserProfile%\vimfiles\syntax
        :autocmd BufNewFile,BufRead *.txt set filetype=txt

		"
        " Update syntax coloring for various DMS parameter files
        "
        :autocmd BufNewFile,BufRead MSGFDB*.txt set filetype=R
        :autocmd BufNewFile,BufRead MSGFPlus*.txt set filetype=R
        :autocmd BufNewFile,BufRead MODa*.txt set filetype=R
        :autocmd BufNewFile,BufRead MSPF*.txt set filetype=R
